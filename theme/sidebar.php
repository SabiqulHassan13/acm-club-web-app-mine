...
<div class="left-side-menu">
    ...
    <div class="slimscroll-menu">
        ...
        <div class="user-box text-center">
            <img src="assets/images/users/1.jpg" alt="user-img" title="Sami Rahman" class="rounded-circle img-thumbnail avatar-lg">
            <div class="dropdown">
                <a href="#" class="text-dark dropdown-toggle h5 mt-2 mb-1 d-block" data-toggle="dropdown">Sami Rahman</a>
            ...
            <p class="text-muted">Senior Member</p>
            <ul class="list-inline">
                ...
                <li class="list-inline-item">
                    <a href="libs/logout.php" class="text-custom">
